...
public class JpaManufacturerComponent implements ManufacturerComponent
{
    private static ManufacturerComponent m_instance = new JpaManufacturerComponent();

    public JpaManufacturerComponent()
    {
    }
