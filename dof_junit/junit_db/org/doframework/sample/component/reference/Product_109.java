...
*/
public class Product_109 extends ProductReferenceBuilder
{
    private static final int PRIMARY_KEY = 109;
    ...
    public Object create()
    {
        ...
        Product product = new Product(PRIMARY_KEY, "Acai Juice", 8, manufacturer52);
        product.setNew(true);
