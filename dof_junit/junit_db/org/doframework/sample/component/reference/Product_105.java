 ...
 */
public class Product_105 extends ProductReferenceBuilder
{
    private static final int PRIMARY_KEY = 105;
    ...
    public Object create()
    {
        ...
        Product product = new Product(PRIMARY_KEY, "Unfiltered Apple Juice", 13, manufacturer51);
        product.setNew(true);
