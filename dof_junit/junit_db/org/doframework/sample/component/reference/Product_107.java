...
*/
public class Product_107 extends ProductReferenceBuilder
{
    private static final int PRIMARY_KEY = 107;
    ...
    {
        Manufacturer manufacturer52 = (Manufacturer) DOF.require(new Manufacturer_52());
        Product product = new Product(PRIMARY_KEY, "Blueberry Juice", 100, manufacturer52);
        product.setNew(true);
    ...
    {
        return new ReferenceBuilder[]{new Manufacturer_52()};
    }
