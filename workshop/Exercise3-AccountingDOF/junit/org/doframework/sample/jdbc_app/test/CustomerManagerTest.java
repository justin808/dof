...
public class CustomerManagerTest extends TestCase
{
	...
	private void deleteInvoicesFor(Customer customer) {
        ...
        InvoiceFactory factory = GlobalContext.getFactoryLookupService().getInvoiceFactory();
    ...
    public void testCreateNewCustomer() {
    	...
    	CustomerFactory factory = GlobalContext.getFactoryLookupService().getCustomerFactory();
    ...
    public void brokenTestOverdueCalculationForMultipleInvoicesOverdue()
    {
        ...
        Customer currenFromDB =
                GlobalContext.getFactoryLookupService().getCustomerFactory().getById(curren.getId());
