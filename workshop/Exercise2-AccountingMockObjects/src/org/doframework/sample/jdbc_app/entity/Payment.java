...
import org.doframework.sample.jdbc_app.factory.PaymentFactory;
...
public class Payment
{
    ...
    public PaymentFactory getPaymentComponent()
    {
        return GlobalContext.getFactoryLookupService().getPaymentFactory();
    }
