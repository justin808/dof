...
public class JdbcDbUtil
{
    ...
    static Connection getConnection() throws SQLException
    {
        if (connection == null)
        {
            connection = DriverManager
                    .getConnection(Configuration.getDbUrl(), Configuration.getDbUser(), Configuration.getDbPassword());
        }
        return connection;
    }
     ...
     */
    public static synchronized void query(String expression, ResultSetProcessor resultSetProcessor) throws SQLException
    {
    ...
    /**
     * WARNING -- not for production code -- not threadsafe if dateFormat member shared in multiple threads!
     *
     * @param date
     *
     * @return
    ...
    public static String formatDate(java.util.Date date)
    {
        ...
        else // Next line not added test driven --> show code coverage and add a test
        {
            return "null";
        }
    }
    ...
    /**
     * Parse a string date or return null if null passed in
     *
     * @param sDate the date to parse
     *
     * @return the value converted to a real date
     */
