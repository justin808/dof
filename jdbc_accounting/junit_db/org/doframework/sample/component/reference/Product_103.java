 ...
 */
public class Product_103 extends ProductReferenceBuilder
{
    private static final int PRIMARY_KEY = 103;
    ...
    public Object create()
    {
        ...
        Product product = new Product(PRIMARY_KEY, "Apple Juice", 13, manufacturer50);
        product.setNew(true);
