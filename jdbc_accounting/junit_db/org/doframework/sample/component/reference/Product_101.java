 ...
 */
public class Product_101 extends ProductReferenceBuilder
{
    private static final int PRIMARY_KEY = 101;
    ...
    public Object create()
    {
        ...
        Product product = new Product(PRIMARY_KEY, "Grape Juice", 150, manufacturer50);
        product.setNew(true);
