 ...
 */
public class Product_108 extends ProductReferenceBuilder
{
    private static final int PRIMARY_KEY = 108;
    ...
    public Object create()
    {
        ...
        Product product = new Product(PRIMARY_KEY, "Acai Juice", 13, manufacturer52);
        product.setNew(true);
