...
*/
public class Product_102 extends ProductReferenceBuilder
{
    private static final int PRIMARY_KEY = 102;
    ...
    public Object create()
    {
        ...
        Product product = new Product(PRIMARY_KEY, "Cranberry Juice", 100, manufacturer50);
        product.setNew(true);
